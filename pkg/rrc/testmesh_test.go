...
func newTestMesh(t *testing.T, basePort int, hubCfg HubConfig) *testMesh {
	...
	ifaceH1 := startTestUDP(t, "H1", addrH, addrA, trH)
	ifaceA := startTestUDP(t, "A", addrA, addrH, trA)
	ifaceH2 := startTestUDP(t, "H2", addrH2, addrB, trH)
	ifaceB := startTestUDP(t, "B", addrB, addrH2, trB)
